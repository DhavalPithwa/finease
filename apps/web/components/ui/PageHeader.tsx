...
export function PageHeader({
  ...
  return (
    <div
      className={`sticky top-16 z-40 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md -mx-4 px-4 pt-4 pb-2 border-b border-slate-200 dark:border-white/5 ${className}`}
    >
